...
compatible with lua 5.2--5.4 and with luajit, provided luajit
is compiled with the `-DLUAJIT_ENABLE_LUA52COMPAT` option, as
it often is not in official distributions.
It has no external dependencies. You can run it with
`lua ./bin/main.lua`.
